...
python3 tools/neo4j-import/packages_to_neo.py \
        ...
        > tools/neo4j_import/out/neo_pkg.csv
echo ""
...
python3 tools/neo4j-import/version_nodes_to_neo.py \
        ...
        > tools/neo4j_import/out/neo_ver.csv
echo ""
...
python3 tools/neo4j-import/version_rels_to_neo.py \
        ...
        dasea_data/ports/netbsd9/netbsd9_versions_05-17-2022.csv \
        dasea_data/ports/openbsd69/openbsd69_versions_05-17-2022.csv \
        > tools/neo4j_import/out/neo_ver_rels.csv
echo ""
...
python3 tools/neo4j-import/deps_to_neo.py \
        ...
        > tools/neo4j_import/out/neo_deps.csv

neo4j stop
neo4j-admin import \
           --database=neo4j \
           --nodes=tools/neo4j_import/out/neo_pkg.csv \
           --nodes=tools/neo4j_import/out/neo_ver.csv \
           --relationships=tools/neo4j_import/out/neo_ver_rels.csv \
           --relationships=tools/neo4j_import/out/neo_deps.csv \
